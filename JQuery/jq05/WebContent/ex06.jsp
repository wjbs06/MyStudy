...
<script type="text/javascript">
	$(function(){
		...
		$('.form>button').click(function(){
			var id=$(this).parent().filter('input').first().val();
			var pw=$(this).parent().filter('input').last().val();
...
<body>
	<div class="container_12">
		...
		<div class="grid_12 content">
			<div class="bxslider">
				<div><img alt="img" src="imgs/big/img01.jpg"></div>
				<div><img alt="img" src="imgs/big/img02.jpg"></div>
				<div><img alt="img" src="imgs/big/img03.jpg"></div>
				<div><img alt="img" src="imgs/big/img04.jpg"></div>
				<div><img alt="img" src="imgs/big/img05.jpg"></div>
				<div><img alt="img" src="imgs/big/img06.jpg"></div>
			</div>
		</div>
		<div class="clear"></div>
		<div id="footer" class="grid_12">
			<address>배트캠프 서울시 서초구 서초동 1327-15 비트아카데미빌딩</address>
			Copyright &copy; 비트캠프 All
		</div>
		<div class="clear"></div>
	</div>
</body>
