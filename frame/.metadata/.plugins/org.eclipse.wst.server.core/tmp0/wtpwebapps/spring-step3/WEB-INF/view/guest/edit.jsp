...
<body>
	...
	<form action="update.bit" method="post">
		<div class="form-group">
			...
			<div calss="well well-sm">${bean.sabun }</div>
			<input type="hidden" name="sabun" value="${bena.sabun }" id="sabun">		
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div calss="well well-sm">${bean.nalja }</div>
			<input type="hidden" name="nalja" value="${bean.nalja }" id="nalja">		
		</div>
		<div class="form-group">
